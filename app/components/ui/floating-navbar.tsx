      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 hover:bg-yellow-500  p-2  hover:rounded-xl  items-center flex space-x-1 text-neutral-600 dark:hover:text-black hover:text-neutral-500"
            )}
          >
